...
var _invariant = __webpack_require__(7927);
...
exports.Fe = withPrefix;
exports.Zf = withAssetPrefix;
exports.oo = exports.Ay = void 0;
...
var _react = _interopRequireDefault(__webpack_require__(5141));

var _reachRouter = __webpack_require__(1693);

var _utils = __webpack_require__(8371);
...
var React = _interopRequireWildcard(__webpack_require__(5141));
...
var _react = __webpack_require__(5141);
...
const preferDefault=m=>m&&m.default||m;exports.components={"component---src-pages-404-js":preferDefault(__webpack_require__(7087)),"component---src-pages-about-js":preferDefault(__webpack_require__(4812)),"component---src-pages-blog-js":preferDefault(__webpack_require__(4544)),"component---src-pages-careers-js":preferDefault(__webpack_require__(3188)),"component---src-pages-contact-js":preferDefault(__webpack_require__(8504)),"component---src-pages-index-js":preferDefault(__webpack_require__(9358)),"component---src-pages-pricing-js":preferDefault(__webpack_require__(6396))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(493),options:{"plugins":[]}},{name:'gatsby-plugin-image',plugin:__webpack_require__(3009),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(6887),options:{"plugins":[],"name":"gatsby-starter-default","short_name":"starter","start_url":"/","background_color":"#663399","theme_color":"#663399","display":"minimal-ui","icon":"src/images/gatsby-icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"6202ee36123b3c392df0756f0eb7166a"}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
//   },
// ]
const apis=__webpack_require__(3472);function augmentErrorWithPlugin(plugin,err){if(plugin.name!==`default-site-plugin`){// default-site-plugin is user code and will print proper stack trace,
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5141);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  Link: () => (/* reexport */ gatsby_link/* default */.Ay),
  ...
  navigate: () => (/* reexport */ gatsby_link/* navigate */.oo),
  parsePath: () => (/* reexport */ gatsby_link/* parsePath */.Rr),
  ...
  withAssetPrefix: () => (/* reexport */ gatsby_link/* withAssetPrefix */.Zf),
  withPrefix: () => (/* reexport */ gatsby_link/* withPrefix */.Fe)
});

// EXTERNAL MODULE: external "/home/jeff/Projects/clickmarket-landing/node_modules/react/index.js"
var index_js_ = __webpack_require__(5141);
...
var find_path = __webpack_require__(1173);
...
if(this.prefetchDisabled){return false;}const realPath=(0,find_path.findPath)(pagePath);// Todo make doPrefetch logic cacheable
// eslint-disable-next-line consistent-return
this.doPrefetch(realPath).then(()=>{if(!this.prefetchCompleted.has(pagePath)){this.apiRunner(`onPostPrefetchPathname`,{pathname:pagePath});this.prefetchCompleted.add(pagePath);}});return true;}doPrefetch(pagePath){const pageDataUrl=createPageDataUrl(pagePath);return _cache_prefetch(pageDataUrl,{crossOrigin:`anonymous`,as:`fetch`}).then(()=>// This was just prefetched, so will return a response from
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(5141));var _gatsby=__webpack_require__(5575);var _common=__webpack_require__(9975);var _getManifestPathname=_interopRequireDefault(__webpack_require__(3901));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5141);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
const Button=({title,colorClass,textColor,onClick,marginClass})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button",{onClick:onClick,className:`${colorClass} ${textColor} ${marginClass} px-3 py-2 rounded-lg text-sm transform scale-100 transition hover:scale-110 active:scal
    -95 focus:outline-none focus:ring-1 focus:ring-offset-1 sm:width-full md:width-full lg:width-full`},title);};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Button);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5141);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
const Input=({placeholder,onChange})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input",{type:"text",placeholder:placeholder,onChange:onChange,className:"px-2 py-2 rounded-lg bg-white bg-opacity-20 border-transparent flex-1 appearance-none text-white font-poppins focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent sm:width-full md:width-full xxs:text-sm"});};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Input);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5141);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Atoms_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8977);
/* harmony import */ var react_reveal_Fade__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5438);
/* harmony import */ var react_reveal_Fade__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_reveal_Fade__WEBPACK_IMPORTED_MODULE_2__);
const PricingMain=()=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"max-w-7xl mx-auto px-6 h-screen xxs:hidden xs:hidden sm:hidden lg:block"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react_reveal_Fade__WEBPACK_IMPORTED_MODULE_2___default()),{bottom:true},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"w-full palette-red flex items-center justify-center h-screen rounded-xl"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"flex w-9/12 bg-white h-auto rounded-xl"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"p-8 w-3/5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-3xl font-bold"},"Unlimited access to all",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),"products."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"mt-5 text-sm opacity-50 font-semibold"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"mt-5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"font-bold text-xl"},"What's Included"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"mt-5 grid grid-cols-2 gap-3"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,"Feature One"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,"Feature Two"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,"Feature Three"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,"Feature Four")))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"flex flex-col items-center justify-center w-2/5 p-8 bg-pink rounded-r-lg"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-xl text-white text-bold"},"All updates for one year"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-7xl text-white font-bold mt-2"},"$149"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"mt-5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Atoms_button__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,{colorClass:"bg-white",title:"Solicitar contato",onClick:()=>{}})))))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PricingMain);
...
var gatsby_browser_entry = __webpack_require__(5575);
;// CONCATENATED MODULE: ./src/components/footer.js
const Footer=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto p-20 mt-10 highlights rounded-xl"},/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-2 xxs:grid-cols-1 lg:grid-cols-2"},/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-4xl text-bold"},"click market"),/*#__PURE__*/index_js_default().createElement("p",{className:"text-white text-sm mt-5 opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries."),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-lg mt-20 "},"\xA9 copyright"," ",/*#__PURE__*/index_js_default().createElement("a",{href:"#"},"clickmarket.pt"))),/*#__PURE__*/index_js_default().createElement("div",{className:"place-self-end self-center xxs:hidden lg:block"},/*#__PURE__*/index_js_default().createElement("ul",{className:"text-xl font-poppins font-bold"},/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"Quem somos")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"Servi\xE7os personalizados")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"Solu\xE7\xF5es"))," ",/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"Trabalhe conosco")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"Contato"))))));};/* harmony default export */ const footer = (Footer);
;// CONCATENATED MODULE: ./src/images/logo.png
/* harmony default export */ const logo = "https://raw.githubusercontent.com/clickmarket/landing/main/static/logo-eeae7f5101f81b461d5b2f8ca0221cbd.png";
;// CONCATENATED MODULE: ./src/components/navbar.js
const Navbar=()=>{const{0:openMenu,1:setOpenMenu}=(0,index_js_.useState)(false);return/*#__PURE__*/index_js_default().createElement("nav",{className:"bg-transparent"},/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto px-8 py-5"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex items-center justify-between h-16"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full justify-between flex items-center"},/*#__PURE__*/index_js_default().createElement("a",{className:"text-white flex-shrink-0 font-poppins",href:"/"},/*#__PURE__*/index_js_default().createElement("img",{src:logo,className:"logo"})),/*#__PURE__*/index_js_default().createElement("div",{className:"hidden md:block"},/*#__PURE__*/index_js_default().createElement("div",{className:"ml-10 flex items-baseline space-x-4"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-white opacity-50 hover:opacity-100 px-3 py-2 rounded-md text-sm font-medium font-poppins",to:"#"},"Quem somos"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-white opacity-50 hover:opacity-100 px-3 py-2 rounded-md text-sm font-medium font-poppins",to:"#"},"Servi\xE7os"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-white opacity-50 hover:opacity-100 px-3 py-2 rounded-md text-sm font-medium font-poppins",to:"#"},"Solu\xE7\xF5es"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-white opacity-50 hover:opacity-100 px-3 py-2 rounded-md text-sm font-medium font-poppins",to:"#"},"Trabalhe conosco"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-white opacity-50 hover:opacity-100 px-3 py-2 rounded-md text-sm font-medium font-poppins",to:"#"},"Contato")))),/*#__PURE__*/index_js_default().createElement("div",{className:"-mr-2 flex md:hidden"},/*#__PURE__*/index_js_default().createElement("button",{onClick:()=>setOpenMenu(!openMenu),className:"text-gray-800 dark:text-white hover:text-gray-300 inline-flex items-center justify-center p-2 rounded-md focus:outline-none"},/*#__PURE__*/index_js_default().createElement("svg",{width:"20",height:"20",fill:"white",className:"h-8 w-8",viewBox:"0 0 1792 1792",xmlns:"http://www.w3.org/2000/svg"},/*#__PURE__*/index_js_default().createElement("path",{d:"M1664 1344v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zm0-512v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zm0-512v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45z"})))))),openMenu&&/*#__PURE__*/index_js_default().createElement("div",{className:"md:hidden"},/*#__PURE__*/index_js_default().createElement("div",{className:"md-px-2 pt-2 pb-3 space-y-1 sm:px-3"},/*#__PURE__*/index_js_default().createElement("a",{className:"text-gray-300 hover:text-gray-800 dark:hover:text-white block px-3 py-2 rounded-md text-base font-medium",href:"/#"},"Quem somos"),/*#__PURE__*/index_js_default().createElement("a",{className:"text-gray-800 dark:text-white block px-3 py-2 rounded-md text-base font-medium",href:"/#"},"Servi\xE7os"),/*#__PURE__*/index_js_default().createElement("a",{className:"text-gray-300 hover:text-gray-800 dark:hover:text-white block px-3 py-2 rounded-md text-base font-medium",href:"/#"},"Solu\xE7\xF5es"),/*#__PURE__*/index_js_default().createElement("a",{className:"text-gray-300 hover:text-gray-800 dark:hover:text-white block px-3 py-2 rounded-md text-base font-medium",href:"/#"},"Contato"))));};/* harmony default export */ const navbar = (Navbar);
 ...
 */const Layout=({children})=>{return/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement(navbar,null),children,/*#__PURE__*/index_js_.createElement(footer,null));};/* harmony default export */ const layout = (Layout);
...
var layout = __webpack_require__(716);
// EXTERNAL MODULE: ./node_modules/prop-types/index.js
var prop_types = __webpack_require__(5556);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
...
;// CONCATENATED MODULE: ./src/components/about/aboutTeamCard.js
const AboutTeamCard=({imgSrc,position})=>{return/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-96 relative overflow-hidden rounded-xl flex flex-col justify-end items-center"},/*#__PURE__*/index_js_default().createElement("img",{className:"object-cover h-full w-full absolute",src:imgSrc}),/*#__PURE__*/index_js_default().createElement("h1",{className:"bg-white absolute p-2 rounded-xl w-3/4 mb-4 text-center"},position)));};/* harmony default export */ const aboutTeamCard = (AboutTeamCard);
;// CONCATENATED MODULE: ./src/components/about/aboutGrid.js
const AboutGrid=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-20 grid grid-cols-3 gap-16 justify-items-center xxs:grid-cols-1 sm:grid-cols-3"},/*#__PURE__*/index_js_default().createElement(aboutTeamCard,{imgSrc:"https://images.unsplash.com/photo-1534030347209-467a5b0ad3e6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80",position:"Justin, CTO"}),/*#__PURE__*/index_js_default().createElement(aboutTeamCard,{imgSrc:"https://images.unsplash.com/photo-1507038732509-8b1a9623223a?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTAwfHxwZW9wbGV8ZW58MHwxfDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",position:"John, CEO"}),/*#__PURE__*/index_js_default().createElement(aboutTeamCard,{imgSrc:"https://images.unsplash.com/photo-1515468381879-40d0ded81044?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTA3fHxwZW9wbGV8ZW58MHwxfDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",position:"Sophia, Manager"}),/*#__PURE__*/index_js_default().createElement(aboutTeamCard,{imgSrc:"https://images.unsplash.com/photo-1536096928601-99bac26a838b?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTE5fHxwZW9wbGV8ZW58MHwxfDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",position:"Kristina, Designer"}),/*#__PURE__*/index_js_default().createElement(aboutTeamCard,{imgSrc:"https://images.unsplash.com/photo-1484515991647-c5760fcecfc7?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTI1fHxwZW9wbGV8ZW58MHwxfDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",position:"Devin Ferry, Manager"}),/*#__PURE__*/index_js_default().createElement(aboutTeamCard,{imgSrc:"https://images.unsplash.com/photo-1539125530496-3ca408f9c2d9?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTI4fHxwZW9wbGV8ZW58MHwxfDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",position:"David, Developer"}));};/* harmony default export */ const aboutGrid = (AboutGrid);
;// CONCATENATED MODULE: ./src/components/about/aboutHeader.js
const AboutHeader=()=>{return/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10"},/*#__PURE__*/index_js_default().createElement("div",{className:"overflow-hidden rounded-xl"},/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2851&q=80"})),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("span",{className:"text-white text-sm opacity-50"},"About us"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-7xl font-poppins font-semibold leading-snug xxs:text-lg xs:text-lg sm:text-3xl lg:text-7xl"},"We're on a mission to reinvent web, UX, product, and content design - by making it visual.if that sounds good to you, you should apply."))));};/* harmony default export */ const aboutHeader = (AboutHeader);
;// CONCATENATED MODULE: ./src/components/about/aboutMore.js
const AboutMore=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10"},/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-3 h-full overflow-hidden gap-4 xxs:grid-cols-1 xs:grid-cols-1 sm:grid-cols-3"},/*#__PURE__*/index_js_default().createElement("div",{className:"col-start-1 col-end-3 h-96 overflow-hidden rounded-xl"},/*#__PURE__*/index_js_default().createElement("img",{className:"object-cover h-96 w-full",src:"https://images.unsplash.com/photo-1531844251246-9a1bfaae09fc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2890&q=80"})),/*#__PURE__*/index_js_default().createElement("div",{className:"col-start-3 overflow-hidden rounded-xl h-96 xxs:col-start-1 sm:col-start-3"},/*#__PURE__*/index_js_default().createElement("img",{className:"object-cover h-96",src:"https://images.unsplash.com/photo-1543269865-cbf427effbad?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80"})))),/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-4"},/*#__PURE__*/index_js_default().createElement("p",{className:"col-start-3 col-end-5 text-white text-3xl leading-normal mt-10 xxs:col-start-1 sm:col-start-3 xxs:text-sm xs:text-lg sm:text-3xl"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.")));};/* harmony default export */ const aboutMore = (AboutMore);
;// CONCATENATED MODULE: ./src/components/about/aboutTeamBigCard.js
const AboutTeamBigCard=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10"},/*#__PURE__*/index_js_default().createElement("div",{className:"highlights w-full h-full flex flex-row justify-between rounded-xl xxs:flex-col sm:flex-row"},/*#__PURE__*/index_js_default().createElement("img",{className:"w-3/4 object-cover h-96 rounded-l-lg xxs:w-full sm:w-3/4",src:"https://images.unsplash.com/photo-1528241725452-5a0eff84abe3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80"}),/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col justify-between"},/*#__PURE__*/index_js_default().createElement("div",{className:"text-white text-right m-6 font-poppins xxs:text-center sm:text-right"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-5xl font-bold"},"Christian Muller"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-lg font-bold opacity-50"},"Founder")),/*#__PURE__*/index_js_default().createElement("p",{className:"text-white p-6 text-xl text-right xxs:text-center sm:text-right"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged."," "))));};/* harmony default export */ const aboutTeamBigCard = (AboutTeamBigCard);
// EXTERNAL MODULE: ./src/components/layout.js + 3 modules
var layout = __webpack_require__(716);
;// CONCATENATED MODULE: ./src/pages/about.js
const About=()=>{return/*#__PURE__*/index_js_default().createElement(layout/* default */.A,null,/*#__PURE__*/index_js_default().createElement(aboutHeader,null),/*#__PURE__*/index_js_default().createElement(aboutMore,null),/*#__PURE__*/index_js_default().createElement(aboutTeamBigCard,null),/*#__PURE__*/index_js_default().createElement(aboutGrid,null));};/* harmony default export */ const about = (About);
...
const BlogHeader=()=>{return/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true},/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10 flex text-white xxs:flex-col sm:flex-row"},/*#__PURE__*/index_js_default().createElement("div",{className:"h-full object-cover overflow-hidden rounded-xl m-5"},/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.unsplash.com/photo-1527689368864-3a821dbccc34?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80"})),/*#__PURE__*/index_js_default().createElement("div",{className:"m-5"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-sm opacity-50"},"Design Process"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-5xl font-bold font-poppins xxs:text-lg sm:text-5xl"},"Web Design Blog you should be reading"),/*#__PURE__*/index_js_default().createElement("p",{className:"text-lg mt-4 opacity-50 xxs:text-sm sm:text-lg"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."),/*#__PURE__*/index_js_default().createElement("div",{className:"flex items-center mt-5"},/*#__PURE__*/index_js_default().createElement("div",{className:"h-10 w-10 object-cover overflow-hidden rounded-full"},/*#__PURE__*/index_js_default().createElement("img",{className:"h-10 w-10",src:"https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"})),/*#__PURE__*/index_js_default().createElement("div",{className:"ml-2"},/*#__PURE__*/index_js_default().createElement("h2",null,"Christina Solerieu"),/*#__PURE__*/index_js_default().createElement("h4",{className:"text-xs opacity-50"},"Jan 19, 2021"))))));};/* harmony default export */ const blogHeader = (BlogHeader);
// EXTERNAL MODULE: ./src/components/Atoms/input.js
var input = __webpack_require__(7253);
// EXTERNAL MODULE: ./src/components/Atoms/button.js
var Atoms_button = __webpack_require__(8977);
;// CONCATENATED MODULE: ./src/components/Blog/blogsContainer.js
const BlogsContainer=()=>{const blogData=[{img:"https://images.unsplash.com/photo-1498758536662-35b82cd15e29?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzN8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1590650516494-0c8e4a4dd67e?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzR8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1553877522-43269d4ea984?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDF8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTJ8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1507207611509-ec012433ff52?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTh8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1552960394-c81add8de6b8?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjR8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1507209575474-fa61e9d3086b?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Njd8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1488751045188-3c55bbf9a3fa?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjZ8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"},{img:"https://images.unsplash.com/photo-1542330952-bffc55e812b2?ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODV8fHdvcmtpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",heading:"The Quick Brown Fox Jumped over the lazy dog.",para:" Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"}];return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10 text-white"},/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-3 gap-4 xxs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"},blogData.map(blog=>/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("div",{className:"w-96 h-72 overflow-hidden rounded-xl xxs:w-full sm:w-96"},/*#__PURE__*/index_js_default().createElement("img",{className:"h-full w-full object-cover",src:blog.img})),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-3xl mt-2 font-poppins font-bold"},blog.heading),/*#__PURE__*/index_js_default().createElement("p",{className:"text-sm opacity-50 mt-2"},blog.para))))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-72 mt-10 palette-red rounded-xl flex flex-col items-center justify-center"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-poppins font-bold text-3xl"},"Stay in the loop"),/*#__PURE__*/index_js_default().createElement("h2",{className:"text-lg mt-2 opacity-50"},"Join our newsletter to get top news before anyone else"),/*#__PURE__*/index_js_default().createElement("div",{className:"flex-row mt-10"},/*#__PURE__*/index_js_default().createElement(input/* default */.A,{placeholder:"email."}),/*#__PURE__*/index_js_default().createElement(Atoms_button/* default */.A,{colorClass:"bg-white",title:"Subscribe",textColor:"text-black",marginClass:"ml-5"}))));};/* harmony default export */ const blogsContainer = (BlogsContainer);
// EXTERNAL MODULE: ./src/components/layout.js + 3 modules
var layout = __webpack_require__(716);
;// CONCATENATED MODULE: ./src/pages/blog.js
const Blog=()=>{return/*#__PURE__*/index_js_default().createElement(layout/* default */.A,null,/*#__PURE__*/index_js_default().createElement(blogHeader,null),/*#__PURE__*/index_js_default().createElement(blogsContainer,null));};/* harmony default export */ const blog = (Blog);
...
var Fade = __webpack_require__(5438);
var Fade_default = /*#__PURE__*/__webpack_require__.n(Fade);
;// CONCATENATED MODULE: ./src/components/Careers/careersHeader.js
const CareersHeader=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10"},/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"flex"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-2/4 m-2 text-white highlights p-8 rounded-xl"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-sm opacity-50 font-semibold"},"Careers"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-5xl font-bold"},"Join us, and help everyone ",/*#__PURE__*/index_js_default().createElement("br",null)," create for the web."),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-5 opacity-70"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",/*#__PURE__*/index_js_default().createElement("br",null)," ",/*#__PURE__*/index_js_default().createElement("br",null),"It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.")),/*#__PURE__*/index_js_default().createElement("div",{className:"w-2/4 rounded-xl overflow-hidden m-2"},/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80"})))),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-row-reverse mt-10"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-2/5 m-2 text-white highlights p-8 rounded-xl"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-sm opacity-50 font-semibold"},"Careers"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-5xl font-bold"},"Join us, and help everyone ",/*#__PURE__*/index_js_default().createElement("br",null)," create for the web."),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-5 opacity-70"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",/*#__PURE__*/index_js_default().createElement("br",null)," ",/*#__PURE__*/index_js_default().createElement("br",null),"It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.")),/*#__PURE__*/index_js_default().createElement("div",{className:"w-3/5 rounded-xl overflow-hidden m-2"},/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80"})))));};/* harmony default export */ const careersHeader = (CareersHeader);
;// CONCATENATED MODULE: ./src/components/Careers/careersRoles.js
const CareersRoles=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto flex flex-col items-center text-white mt-20 font-poppins"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-sm font-bold opacity-50"},"Join our team"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-6xl font-bold mt-3"},"View open roles"),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-2 gap-6 mt-10"},/*#__PURE__*/index_js_default().createElement("a",{href:"#",className:"m-5 p-5 highlights rounded-xl border cursor-pointer hover:border-purple text-left"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-3xl font-bold"},"Product Design Manager"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-10 opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")),/*#__PURE__*/index_js_default().createElement("a",{href:"#",className:"m-5 p-5 highlights rounded-xl border cursor-pointer hover:border-purple text-left"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-3xl font-bold"},"Senior Data Engineer"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-10 opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")))));};/* harmony default export */ const careersRoles = (CareersRoles);
// EXTERNAL MODULE: ./src/components/layout.js + 3 modules
var layout = __webpack_require__(716);
;// CONCATENATED MODULE: ./src/pages/careers.js
const Careers=()=>{return/*#__PURE__*/index_js_default().createElement(layout/* default */.A,null,/*#__PURE__*/index_js_default().createElement(careersHeader,null),/*#__PURE__*/index_js_default().createElement(careersRoles,null));};/* harmony default export */ const careers = (Careers);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5141);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(716);
/* harmony import */ var _components_Atoms_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7253);
/* harmony import */ var _components_Atoms_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8977);
/* harmony import */ var react_reveal_Fade__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5438);
/* harmony import */ var react_reveal_Fade__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_reveal_Fade__WEBPACK_IMPORTED_MODULE_4__);
const Contact=()=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react_reveal_Fade__WEBPACK_IMPORTED_MODULE_4___default()),{bottom:true,cascade:true},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"max-w-7xl mx-auto mt-10 flex text-white xxs:flex-col sm:flex-row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"highlights p-10 rounded-xl w-3/4 m-5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-xs opacity-50"},"Get in touch"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-4xl font-bold font-poppins mt-2 xxs:text-lg sm:text-2xl lg:text-4xl"},"Let's work together"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"text-lg mt-2 opacity-50 w-3/4 xxs:text-xs xxs:w-full sm:text-sm sm:w-3/4"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form",{className:"mt-5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"flex xxs:flex-col sm:flex-row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"sm:mr-5 xxs:mr-0"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Atoms_input__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{placeholder:"Your Name"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"sm:ml-5 xxs:ml-0 xxs:mt-2 sm:mt-0"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Atoms_input__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{placeholder:"Your Email"}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"flex mt-5 xxs:flex-col sm:flex-row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"sm:mr-5 xxs:mr-0"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Atoms_input__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{placeholder:"Your Company"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"sm:ml-5 xxs:ml-0 xxs:mt-2 sm:mt-0"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Atoms_input__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{placeholder:"Your Phone"}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("textarea",{className:"mt-5 w-full bg-white bg-opacity-20 rounded-xl p-5",rows:"5",placeholder:"How can we help you?"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Atoms_button__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,{title:"Send us a message",colorClass:"palette-red",marginClass:"mt-5"}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"w-1/4 overflow-hidden rounded-xl m-5 xxs:hidden sm:block"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img",{className:"object-cover h-full w-full",src:"https://images.unsplash.com/photo-1537511446984-935f663eb1f4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80"})))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Contact);
...
var Atoms_button = __webpack_require__(8977);
// EXTERNAL MODULE: ./node_modules/react-reveal/Fade.js
var react_reveal_Fade = __webpack_require__(5438);
var Fade_default = /*#__PURE__*/__webpack_require__.n(react_reveal_Fade);
;// CONCATENATED MODULE: ./src/images/header-main.jpg
/* harmony default export */ const header_main = "https://raw.githubusercontent.com/clickmarket/landing/main/static/header-main-f0865aea0afd611642833e142b7e767b.jpg";
;// CONCATENATED MODULE: ./src/components/Home/header.js
// Assets
const Header=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto px-8"},/*#__PURE__*/index_js_default().createElement((Fade_default()),null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h2",{className:"text-white font-poppins opacity-50 font-semibold mt-20 text-xs xxs:text-xs xs:text-xs sm:text-xs md:text-sm lg:text-xl"},"Impulsione suas vendas"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white font-poppins font-semibold text-2xl xxs:text-2xl xs:text-2xl sm:text-lg md:text-2xl lg:text-4xl xl:text-7xl 2xl:text-8xl"},"com um",/*#__PURE__*/index_js_default().createElement("br",null)," "," ",/*#__PURE__*/index_js_default().createElement("span",{class:"text-gradient palette-red"},"click inteligente.")))),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true},/*#__PURE__*/index_js_default().createElement("div",{className:"mt-10 xxs:flex xxs:flex-row sm:block"},/*#__PURE__*/index_js_default().createElement(input/* default */.A,{placeholder:"email."}),/*#__PURE__*/index_js_default().createElement(Atoms_button/* default */.A,{colorClass:"palette-red ",title:"Solicitar contato",textColor:"text-white",marginClass:"ml-5"}))),/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-auto overflow-hidden rounded-xl"},/*#__PURE__*/index_js_default().createElement("img",{className:"w-full h-full",src:header_main,alt:"Header"}))));};/* harmony default export */ const header = (Header);
;// CONCATENATED MODULE: ./src/components/Home/featureSection.js
const FeatureSection=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto "},/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full flex flex-row justify-between mt-10 xxs:flex-col xs:flex-col sm:flex-row"},/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 palette-red hover:from-purple hover:to-pink transition duration-500 ease-in-out"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-5xl"},"60+"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-white"},"mil cliques mensais")),/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 palette-red hover:from-purple hover:to-pink transition duration-500 ease-in-out"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-5xl"},"700+"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-white"},"mil impress\xF5es")),/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 palette-red hover:from-purple hover:to-pink transition duration-500 ease-in-out"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-5xl"},"3+"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-white"},"mil usu\xE1rios di\xE1rios")),/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 palette-red hover:from-purple hover:to-pink transition duration-500 ease-in-out"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-5xl"},"3"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-white"},"solu\xE7\xF5es digitais inteligentes")))),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"mt-10 px-8"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-7xl font-bold xxs:text-2xl xs:text-2xl sm:text-3xl lg:text-5xl xl:text-7xl"},"Por que escolher a",/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement("span",{class:"text-gradient palette-red"},"Click"),"?"))),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"mt-10 flex flex-row justify-space xxs:flex-col xs:flex-col sm:flex-row"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-2/6 palette-red p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-2/6"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-4xl"},"O que fazemos"),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h2",{className:"text-white text-xl"},"Google Meu Neg\xF3cio")),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-white text-xl"},"Google Ads")),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-white text-xl"},"Gest\xE3o de redes sociais")),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-white text-xl"},"Gest\xE3o de tr\xE1fego pago")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-4/6 highlights p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-4/6"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-4xl"},"O que nos motiva"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-10 text-white opacity-50"},"A nossa equipa est\xE1 empenhada em impulsionar a presen\xE7a online de neg\xF3cios como o seu. Oferecemos servi\xE7os diversos que abrem portas para inclus\xE3o e sucesso digital. Descubra como podemos ajud\xE1-lo a crescer, otimizar seus neg\xF3cios e destacar-se num ambiente altamente competitivo.")))),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"mt-10 px-8"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-7xl font-bold xxs:text-2xl xs:text-3xl sm:text-5xl lg:text-7xl"},"Solu\xE7\xF5es \xA0",/*#__PURE__*/index_js_default().createElement("span",{class:"text-gradient palette-red"},"personalizadas")))),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"mt-10 flex flex-row justify-space xxs:flex-col xs:flex-col sm:flex-row"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 palette-red p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-1/3"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-2xl"},"Google Meu Neg\xF3cio"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-10 text-white opacity-50 text-sm"},"Se tem um neg\xF3cio novo ou deseja aumentar o alcance do vosso estabelecimento do seu p\xFAblico alvo, estar nas buscas online \xE9 o primeiro passo para aumentar vossas receitas e divulgar de forma mais ampla o diferencial dos seus servi\xE7os. Neg\xF3cios \u201Coffline\u201D dificilmente conseguem capitar novos clientes.D descubra como podemos ajuda-lo  a aumentar a visibilidade da suavossa empresa, criar uma identidade visual  e destravar seu neg\xF3cios para potenciais clientes.")),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 highlights p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-1/3"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-2xl"},"Google Ads"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-10 text-white opacity-50 text-sm"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.")),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 highlights p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-1/3"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white text-2xl"},"Gest\xE3o de redes sociais"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-10 text-white opacity-50 text-sm"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.")))));};/* harmony default export */ const featureSection = (FeatureSection);
;// CONCATENATED MODULE: ./src/components/Home/testimonial.js
const Testimonial=()=>{return/*#__PURE__*/React.createElement("div",{className:"max-w-7xl mx-auto px-6 mt-10 h-auto mb-10"},/*#__PURE__*/React.createElement(Fade,{bottom:true},/*#__PURE__*/React.createElement("div",{className:"w-full flex flex-row justify-between align-middle highlights p-12 rounded-lg xxs:flex-col xs:flex-col sm:flex-row xxs:p-5 lg:p-12"},/*#__PURE__*/React.createElement("div",{className:"w-3/4 xxs:w-full xs:w-full sm:w-3/4"},/*#__PURE__*/React.createElement("div",{className:"font-poppins text-white font-semibold text-2xl leading-10 xxs:text-xs xxs:font-normal sm:text-2xl"},"\"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.\""),/*#__PURE__*/React.createElement("div",{className:"mt-10"},/*#__PURE__*/React.createElement("h1",{className:"text-white text-3xl font-bold font-poppins"},"Ofelia Bashirian"),/*#__PURE__*/React.createElement("h1",{className:"text-white text-sm font-semibold font-poppins opacity-50"},"Senior Project Manager"))),/*#__PURE__*/React.createElement("div",{className:"w-1/4 overflow-hidden flex align-middle justify-center xxs:hidden sm:block"},/*#__PURE__*/React.createElement("img",{className:"rounded-xl w-auto h-auto",src:"https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8cGVvcGxlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60"})))));};/* harmony default export */ const testimonial = ((/* unused pure expression or super */ null && (Testimonial)));
// EXTERNAL MODULE: ./src/components/Home/pricing.js
var pricing = __webpack_require__(328);
;// CONCATENATED MODULE: ./src/images/mobber.png
/* harmony default export */ const mobber = "https://raw.githubusercontent.com/clickmarket/landing/main/static/mobber-91106247507a72fcf6cd7651ce29a758.png";
;// CONCATENATED MODULE: ./src/images/cialo.png
/* harmony default export */ const cialo = "https://raw.githubusercontent.com/clickmarket/landing/main/static/cialo-b5c7c391a1a8fa1360258eace990e7c3.png";
;// CONCATENATED MODULE: ./src/images/adfluent.png
/* harmony default export */ const adfluent = "https://raw.githubusercontent.com/clickmarket/landing/main/static/adfluent-06365db9f22ea92fd1d721d0841ede23.png";
;// CONCATENATED MODULE: ./src/components/FeaturedBlog.js
const FeaturedBlog=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto px-8 mt-10"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-white font-poppins font-bold text-6xl xxs:text-lg xs:text-xl sm:text-xl lg:text-6xl"},"Solu\xE7\xF5es ",/*#__PURE__*/index_js_default().createElement("br",null)," digitais\xA0",/*#__PURE__*/index_js_default().createElement("span",{class:"text-gradient palette-red"},"inteligentes")),/*#__PURE__*/index_js_default().createElement("p",{className:"text-white text-lg mt-5 opacity-50 w-3/4 xxs:w-full lg:w-3/4"},"Nossos produtos digitais idealizados para potencializar vendas e auxiliar na tomada de decis\xE3o de maneira inteligente."),/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-3 mt-10 gap-4 xxs:grid-cols-1 lg:grid-cols-3"},/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl overflow-hidden relative product-image"},/*#__PURE__*/index_js_default().createElement("img",{className:"relative",alt:"mobber",src:mobber}),/*#__PURE__*/index_js_default().createElement("div",{class:"opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 text-3xl text-white font-bold p-8"},"mobber. - A rede social para compras e descontos.")),/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl overflow-hidden relative product-image"},/*#__PURE__*/index_js_default().createElement("img",{className:"relative",alt:"mobber",src:cialo}),/*#__PURE__*/index_js_default().createElement("div",{class:"opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 text-3xl text-white font-bold p-8"},"Cialo - Transformando feedbacks em insights.")),/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-xl overflow-hidden relative product-image"},/*#__PURE__*/index_js_default().createElement("img",{className:"relative",alt:"blog",src:adfluent}),/*#__PURE__*/index_js_default().createElement("div",{class:"opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 text-3xl text-white font-bold p-8"},"adFluent. - IA para otimiza\xE7\xE3o do Google Ads."))));};/* harmony default export */ const components_FeaturedBlog = (FeaturedBlog);
;// CONCATENATED MODULE: ./src/pages/index.js
// Components
const IndexPage=()=>/*#__PURE__*/index_js_.createElement("div",{className:"h-auto w-screen"},/*#__PURE__*/index_js_.createElement(layout/* default */.A,null,/*#__PURE__*/index_js_.createElement(header,null),/*#__PURE__*/index_js_.createElement(featureSection,null),/*#__PURE__*/index_js_.createElement(components_FeaturedBlog,null)));/* harmony default export */ const pages = (IndexPage);
...
var Fade = __webpack_require__(5438);
var Fade_default = /*#__PURE__*/__webpack_require__.n(Fade);
;// CONCATENATED MODULE: ./src/components/Pricing/pricingHeader.js
const PricingHeader=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10 font-poppins text-white flex flex-col items-center"},/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-6xl font-bold m-5 xxs:text-xl sm:text-4xl lg:text-6xl"},"Simple, transparent pricing"),/*#__PURE__*/index_js_default().createElement("h2",{className:"text-base opacity-50 text-center xxs:text-sm sm:text-lg"},"Get the Circle plan that fits your needsata a special introductory price.")),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-2 gap-4 mt-10 xxs:grid-cols-1 sm:grid-cols-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"highlights p-10 rounded-xl"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-2xl text-gradient palette-red "},"Essential"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-4xl mt-2 font-bold"},"$49/Mo"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-sm mt-2 opacity-50"},"Better insights for growing businesses that want more customers."),/*#__PURE__*/index_js_default().createElement("ul",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas"),/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas"),/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas")),/*#__PURE__*/index_js_default().createElement("button",{className:"mt-5 px-5 palette-red p-2"},"Start Free Trial")),/*#__PURE__*/index_js_default().createElement("div",{className:"highlights p-10 rounded-xl"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-2xl text-gradient palette-red "},"Premium"),/*#__PURE__*/index_js_default().createElement("h1",{className:"text-4xl mt-2 font-bold"},"$79/Mo"),/*#__PURE__*/index_js_default().createElement("h3",{className:"text-sm mt-2 opacity-50"},"Better insights for growing businesses that want more customers."),/*#__PURE__*/index_js_default().createElement("ul",{className:"mt-5"},/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas"),/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas"),/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas"),/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas"),/*#__PURE__*/index_js_default().createElement("li",{className:"text-sm opacity-70 py-2"}," ","- malesuada fames ac turpis egestas")),/*#__PURE__*/index_js_default().createElement("button",{className:"mt-5 px-5 palette-red p-2"},"Start Free Trial")))));};/* harmony default export */ const pricingHeader = (PricingHeader);
// EXTERNAL MODULE: ./src/components/Home/pricing.js
var pricing = __webpack_require__(328);
;// CONCATENATED MODULE: ./src/components/Pricing/pricingFAQ.js
const PricingFAQ=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-10 text-center text-white"},/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-5xl font-poppins font-bold xxs:text-xl sm:text-3xl lg:text-5xl"},"Frequently asked questions")),/*#__PURE__*/index_js_default().createElement((Fade_default()),{bottom:true,cascade:true},/*#__PURE__*/index_js_default().createElement("div",{className:"grid grid-cols-2 gap-8  text-left mt-10 xxs:grid-cols-1 sm:grid-cols-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"xxs:p-2 sm:p-0"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-bold text-2xl font-poppins xxs:text-lg sm:text-2xl"},"Publshing Industries for previewing layouts?"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")),/*#__PURE__*/index_js_default().createElement("div",{className:"xxs:p-2 sm:p-0"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-bold text-2xl font-poppins xxs:text-lg sm:text-2xl"},"Publshing Industries for previewing layouts?"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")),/*#__PURE__*/index_js_default().createElement("div",{className:"xxs:p-2 sm:p-0"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-bold text-2xl font-poppins xxs:text-lg sm:text-2xl"},"Publshing Industries for previewing layouts?"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")),/*#__PURE__*/index_js_default().createElement("div",{className:"xxs:p-2 sm:p-0"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-bold text-2xl font-poppins xxs:text-lg sm:text-2xl"},"Publshing Industries for previewing layouts?"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")),/*#__PURE__*/index_js_default().createElement("div",{className:"xxs:p-2 sm:p-0"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-bold text-2xl font-poppins xxs:text-lg sm:text-2xl"},"Publshing Industries for previewing layouts?"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")),/*#__PURE__*/index_js_default().createElement("div",{className:"xxs:p-2 sm:p-0"},/*#__PURE__*/index_js_default().createElement("h1",{className:"font-bold text-2xl font-poppins xxs:text-lg sm:text-2xl"},"Publshing Industries for previewing layouts?"),/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm opacity-50"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.")))));};/* harmony default export */ const pricingFAQ = (PricingFAQ);
// EXTERNAL MODULE: ./src/components/Atoms/button.js
var Atoms_button = __webpack_require__(8977);
;// CONCATENATED MODULE: ./src/components/Pricing/pricingCTA.js
const PricingCTA=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-7xl mx-auto mt-20 flex flex-col text-white text-center items-center"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-4xl font-bold font-poppins xxs:text-2xl sm:text-4xl"},"Ready to create better products?"),/*#__PURE__*/index_js_default().createElement("p",{className:"text-lg opacity-50 w-2/4 mt-5 xxs:text-sm xxs:w-full xxs:p-2 sm:p-0 sm:w-2/4"},"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"," "),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-2"},/*#__PURE__*/index_js_default().createElement(Atoms_button/* default */.A,{title:"Start Free Trial",colorClass:"palette-red "})));};/* harmony default export */ const pricingCTA = (PricingCTA);
;// CONCATENATED MODULE: ./src/pages/pricing.js
const Pricing=()=>{return/*#__PURE__*/index_js_default().createElement(layout/* default */.A,null,/*#__PURE__*/index_js_default().createElement(pricingHeader,null),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-20"},/*#__PURE__*/index_js_default().createElement(pricing/* default */.A,null)),/*#__PURE__*/index_js_default().createElement(pricingFAQ,null),/*#__PURE__*/index_js_default().createElement(pricingCTA,null));};/* harmony default export */ const pages_pricing = (Pricing);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5141);
...
var React = __webpack_require__(5141);
...
"use strict";
module.exports = require("/home/jeff/Projects/clickmarket-landing/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/home/jeff/Projects/clickmarket-landing/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/home/jeff/Projects/clickmarket-landing/node_modules/react/index.js");
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"app":["/app-1e81f1d06d98003a19e4.js"],"component---src-pages-404-js":["/component---src-pages-404-js-4514f07b6bffc268cf01.js"],"component---src-pages-about-js":["/component---src-pages-about-js-e2cd5663731a6a69753d.js"],"component---src-pages-blog-js":["/component---src-pages-blog-js-47f7cf22ece64a8c3012.js"],"component---src-pages-careers-js":["/component---src-pages-careers-js-3785ff462078b8946fb4.js"],"component---src-pages-contact-js":["/component---src-pages-contact-js-2ad87bbf7d6c3328b69f.js"],"component---src-pages-index-js":["/component---src-pages-index-js-633723f6f159acdd8032.js"],"component---src-pages-pricing-js":["/component---src-pages-pricing-js-82a175ed2362a1426703.js"]}');
...
/* harmony export */ });
const static_entry_React=__webpack_require__(5141);const path=__webpack_require__(2003);const{renderToString,renderToStaticMarkup,pipeToNodeWritable}=__webpack_require__(3521);const{ServerLocation,Router,isRedirect}=__webpack_require__(1693);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(5575);const fs=__webpack_require__(1608);const{WritableAsPromise}=__webpack_require__(1956);const{RouteAnnouncerProps}=__webpack_require__(5259);const{apiRunner,apiRunnerAsync}=__webpack_require__(5943);const syncRequires=__webpack_require__(2905);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(1173);const chunkMapping=__webpack_require__(3114);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(2290);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${""}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${""}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${""}/${join(`page-data`,`app-data.json`)}`;const createElement=static_entry_React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
...
headComponents.push(/*#__PURE__*/static_entry_React.createElement("link",{as:"script",rel:script.rel,key:script.name,href:`${""}/${script.name}`}));});if(pageData&&!inlinePageData){headComponents.push(/*#__PURE__*/static_entry_React.createElement("link",{as:"fetch",rel:"preload",key:pageDataUrl,href:pageDataUrl,crossOrigin:"anonymous"}));}staticQueryUrls.forEach(staticQueryUrl=>headComponents.push(/*#__PURE__*/static_entry_React.createElement("link",{as:"fetch",rel:"preload",key:staticQueryUrl,href:staticQueryUrl,crossOrigin:"anonymous"})));const appDataUrl=getAppDataUrl();if(appDataUrl){headComponents.push(/*#__PURE__*/static_entry_React.createElement("link",{as:"fetch",rel:"preload",key:appDataUrl,href:appDataUrl,crossOrigin:"anonymous"}));}reversedStyles.forEach(style=>{// Add <link>s for styles that should be prefetched
// otherwise, inline as a <style> tag
if(style.rel===`prefetch`){headComponents.push(/*#__PURE__*/static_entry_React.createElement("link",{as:"style",rel:style.rel,key:style.name,href:`${""}/${style.name}`}));}else{headComponents.unshift(/*#__PURE__*/static_entry_React.createElement("style",{"data-href":`${""}/${style.name}`,"data-identity":`gatsby-global-css`,dangerouslySetInnerHTML:{__html:style.content}}));}});// Add page metadata for the current page
const windowPageData=`/*<![CDATA[*/window.pagePath="${pagePath}";${inlinePageData?`window.pageData=${JSON.stringify(pageData)};`:``}/*]]>*/`;postBodyComponents.push(/*#__PURE__*/static_entry_React.createElement("script",{key:`script-loader`,id:`gatsby-script-loader`,dangerouslySetInnerHTML:{__html:windowPageData}}));// Add chunk mapping metadata
const scriptChunkMapping=`/*<![CDATA[*/window.___chunkMapping=${JSON.stringify(chunkMapping)};/*]]>*/`;postBodyComponents.push(/*#__PURE__*/static_entry_React.createElement("script",{key:`chunk-mapping`,id:`gatsby-chunk-mapping`,dangerouslySetInnerHTML:{__html:scriptChunkMapping}}));let bodyScripts=[];if(chunkMapping[`polyfill`]){chunkMapping[`polyfill`].forEach(script=>{const scriptPath=`${""}${script}`;bodyScripts.push(/*#__PURE__*/static_entry_React.createElement("script",{key:scriptPath,src:scriptPath,noModule:true}));});}// Filter out prefetched bundles as adding them as a script tag
// would force high priority fetching.
bodyScripts=bodyScripts.concat(scripts.filter(s=>s.rel!==`prefetch`).map(s=>{const scriptPath=`${""}/${JSON.stringify(s.name).slice(1,-1)}`;return/*#__PURE__*/static_entry_React.createElement("script",{key:scriptPath,src:scriptPath,async:true});}));postBodyComponents.push(...bodyScripts);apiRunner(`onPreRenderHTML`,{getHeadComponents,replaceHeadComponents,getPreBodyComponents,replacePreBodyComponents,getPostBodyComponents,replacePostBodyComponents,pathname:pagePath,pathPrefix:""});const html=`<!DOCTYPE html>${renderToStaticMarkup(/*#__PURE__*/static_entry_React.createElement(Html,Object.assign({},bodyProps,{headComponents:headComponents,htmlAttributes:htmlAttributes,bodyAttributes:bodyAttributes,preBodyComponents:preBodyComponents,postBodyComponents:postBodyComponents,body:bodyHtml,path:pagePath})))}`;return{html,unsafeBuiltinsUsage:global.unsafeBuiltinUsage};}catch(e){e.unsafeBuiltinsUsage=global.unsafeBuiltinUsage;throw e;}}
})();
